...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "Simple Filter Queries for Ruby on Rails."
  spec.description = "Provides a base class and a set of modules to build query objects for Rails applications."
  spec.license     = "MIT"
