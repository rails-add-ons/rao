  ...
  module ResourcesController
    module Singular
      ...
      module RestResourcesUrlsConcern
        ...
        # Returns the path for editing the resource (e.g., /profile).
        ...
        # Returns the path for creating the resource (e.g., /profile/new).
        def new_resource_path(options = {})
          resource_router.new_polymorphic_path([resource_namespace, resource_class].flatten.compact, options)
        end

        # Returns the path for the resource (e.g., /profile).
        def resource_path(resource, options = {})
          resource_router.polymorphic_path([resource_namespace, resource_class.model_name.singular.to_sym].flatten.compact, options)
        end

        # Returns the path for updating the resource (e.g., /profile).
