...
class AwesomeNestedSet {
  ...
  initializeDragAndDrop() {
    const items = document.querySelectorAll('[data-awesome-nested-set-item]');
  ...
  makeDraggable(element) {
    ...
    element.addEventListener('dragstart', (e) => {
      ...
      e.dataTransfer.setData('text/plain', element.getAttribute('data-awesome-nested-set-item-uid'));
  ...
  makeDroppable(element) {
    const redirectTarget = element.getAttribute('data-awesome-nested-set-item-on-drop-target');
    const scope = element.getAttribute('data-awesome-nested-set-item-scope');
  ...
  isValidDrop(draggedElement, dropTarget, scope) {
    ...
    const draggedScope = draggedElement.getAttribute('data-awesome-nested-set-item-scope');
